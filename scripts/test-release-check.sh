...
require_text .github/workflows/release.yml '} >> "$GITHUB_OUTPUT"'
require_text .github/workflows/release.yml 'write_outputs "tag=$tag" "active=false" "publish=false"'
require_text .github/workflows/release.yml 'write_outputs "tag=$tag" "active=true"'
require_text .github/workflows/release.yml 'write_outputs "publish=false"'
require_text .github/workflows/release.yml 'write_outputs "publish=true"'
